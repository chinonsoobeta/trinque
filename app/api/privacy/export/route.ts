...
import { groupMembers, groupRsvps, groupVotes, groups, preferences, publishedDishes, saves, userConsents, users } from "@/db/schema";
...
export async function GET(request: Request) {
  ...
  const [account, preference, consent, saved, dishes, memberships, votes, rsvps, ownedGroups] = await Promise.all([
