...
export const profiles = sqliteTable("profiles", {
  ...
  favoriteCuisines: text("favorite_cuisines").notNull().default("[]"),
...
export const preferences = sqliteTable("preferences", {
  ...
  locationCountryCode: text("location_country_code", { enum: SUPPORTED_COUNTRY_CODES }),
...
export const analyticsEvents = sqliteTable("analytics_events", {
  ...
  language: text("language", { enum: ["en-CA", "en-US", "en-GB", "fr", "es", "de", "it", "pt"] }),
  countryCode: text("country_code", { enum: SUPPORTED_COUNTRY_CODES }),
...
export const restaurants = sqliteTable("restaurants", {
  ...
  countryCode: text("country_code", { enum: SUPPORTED_COUNTRY_CODES }).notNull(),
  address: text("address").notNull(),
  currencyCode: text("currency_code", { enum: SUPPORTED_CURRENCY_CODES }).notNull(),
...
export const publishedDishes = sqliteTable("published_dishes", {
  ...
  currencyCode: text("currency_code", { enum: SUPPORTED_CURRENCY_CODES }),
...
export const groups = sqliteTable("groups", {
  ...
  distanceUnit: text("distance_unit", { enum: ["metric", "imperial"] }).notNull().default("metric"),
  ...
  cuisineTypes: text("cuisine_types").notNull().default("[]"),
  ...
  locale: text("locale"),
  displayLanguage: text("display_language", { enum: ["en-CA", "en-US", "en-GB", "fr", "es", "de", "it", "pt"] }).notNull().default("en-CA"),
