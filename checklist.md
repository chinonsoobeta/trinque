...
- [x] Saves and preferences use the libSQL database as the authoritative store.

## Phase 2 — publish and nearby matching

- [x] Reviewed dishes persist to the libSQL database and uploaded images to Supabase Storage.
