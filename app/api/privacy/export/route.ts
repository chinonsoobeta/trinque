...
export async function GET(request: Request) {
  ...
  const [account, preference, consent, saved, dishes, memberships, votes, rsvps, ownedGroups, analytics, feedback, clientErrors] = await Promise.all([
